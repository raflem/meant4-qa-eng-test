...
EMPTY_CART_XPATH = "//*[contains(@class, 'ajax_cart_no_product') and contains(text(), '(empty)')]"
EXAMPLE_DRESS_HREF = "http://www.automationpractice.pl/index.php?id_product=7&amp;controller=product"
